...
public class AddTitleByGenre extends AppCompatActivity implements RecycleViewAdapterGenreList.ItemListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_title_by_genre);
        initview();
